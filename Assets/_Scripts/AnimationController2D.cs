...
/// <summary>
/// This Script updates animations as needed.
/// It also switches the direction of the sprite depending on which way the player is moving.
/// </summary>
public class AnimationController2D : MonoBehaviour
{
	...
	public void setAnimation (string animationName)
    {
		...
		if (_animator != null && _animator.HasState(0,hash)) // If animator has the clip
        {
